...
> = ({ columns = [], action = null, token = "",angkatan=false }) => {
  ...
  function pagination(page: any) {
    async function fetchData() {
      ...
      const data = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/alumni?approval=false&pages=${page}${filterAngkatan}`,
        {
          method: "GET",
          headers: {
      ...
      const isNext = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/alumni?approval=false&pages=${page + 1}${filterAngkatan}`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      const isNext = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/alumni?approval=false&pages=${pages + 1}${filterAngkatan}`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
